...
func (j *JWTer) GenerateToken(ctx context.Context, u entity.User) ([]byte, error) {
	...
	signed, err := jwt.Sign(token, jwt.WithKey(jwa.RS256, j.PirvateKey))
	if err != nil {
		return nil, err
	}
	return signed, nil
